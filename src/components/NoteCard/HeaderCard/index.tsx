...
export default function Header({
  ...
  return (
    <header className="flex flex-row justify-between items-center w-full pl-5 pr-4 py-2 shadow-sm rounded-t-3xl shadow-[#00000015]">
      <input
        type="text"
        value={title}
        className="text-[#455A64] w-full  placeholder-[#9A9A9A] text-[14.2px] leading-4 font-bold outline-none bg-transparent"
        placeholder="Título"
